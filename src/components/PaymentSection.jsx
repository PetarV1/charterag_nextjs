    ...
    <section className="pt-14 pb-14 bg-[#ECFBFF] ">
      <div className=" max-w-[914px] mx-auto">
        <div className="flex flex-col items-center gap-6 width-[445px] mx-[234.5px]">
          ...
          <h2 className="text-[46px] text-[#062949] font-semibold leading-none text-center">
            You don’t have to break the bank
          </h2>
          <p className="text-[#082A44] text-center font-normal pb-14 text-base leading-[130%]">
            See how lorem ipsum dolor sit
          </p>
        </div>
        <div className="flex gap-[44.2px] pt-14">
          {/* Left Box */}
          <div className="relative rounded-[10px] bg-[#B8E1FF] paymentshadow flex-1 pl-[44px] pt-[38px] pb-[70.62px]">
            <div className="absolute top-[57px] right-[38px] inline-flex p-[10px] bg-[#062949] items-center justify-center gap-[10px] rounded-[10px]">
              <p className="leading-[130%] text-white text-[16px]">from 787€</p>
            </div>
            <h4 className="text-4xl mb-[23px] w-[185px] h-[68px] text-[#062949] leading-[105%] tracking-[-0.64px]">
              Sailweek experience
            </h4>
            <div className="flex flex-col justify-center items-start gap-[12.174px] pt-[23px]">
              {tripPackage.map((item, index) => (
                <div className="flex gap-[6px] items-center">
                  ...
                  />
                  <p className="text-[#062949] text-base font-normal leading-[130%]">
                    {item}
                  </p>
                </div>
              ))}
          ...
          {/* Right Box */}
          <div className="rounded-[10px] bg-[#fff] paymentshadow flex-1 pl-[44px] pt-[38px] pb-[70.62px]">
            <h4 className="text-4xl mb-[23px] w-[185px] h-[68px] text-[#062949] leading-[105%] tracking-[-0.64px]">
              Sailweek experience
            </h4>
            <div className="flex flex-col justify-center items-start gap-[12.174px] pt-[23px]">
